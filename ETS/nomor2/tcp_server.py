...
alldata['5']=dict(nomor=5, nama="Harry Maguire", posisi="beban")
alldata['6']=dict(nomor=6, nama="dean henderson", posisi="kiper")
alldata['7']=dict(nomor=7, nama="luke shaw", posisi="bek kiri")
alldata['8']=dict(nomor=8, nama="aaron wan-bissaka", posisi="bek kanan")
alldata['9']=dict(nomor=9, nama="victor lindelof", posisi="bek tengah kanan")
alldata['10']=dict(nomor=10, nama="Harry Maguire", posisi="beban")
...
def proses_request(request_string):
    ...
    try:
        ...
        if (command == 'getplayer'):
            ...
            logging.warning("Request: getplayer {}".format(nomorpemain))
            try:
